...
- El CSS y el JavaScript viven en `dashboard.css` y `dashboard.js`. La CSP ya no permite `'unsafe-inline'` en scripts; `style-src` todavía lo necesita porque las tablas pintan estilos dinámicos.
