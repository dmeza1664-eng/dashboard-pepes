...
- El dashboard acepta únicamente cuentas de la lista `DASHBOARD_ALLOWED_USER_IDS` que además estén activas y tengan rol de oficina. Hoy entran `admin1` (Admin General) y `carloszerme1` (Carlos). Supervisor y Contadora ya no entran, aunque puedan usar la app Android.
